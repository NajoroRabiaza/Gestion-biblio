        ...
        <div style="max-width: 860px; margin: 0 auto;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 28px;">
                <div>
                    ...
                    <p class="subtitle">{{ $authors->count() }} auteur(s) enregistré(s)</p>
                </div>
                ...
                @foreach($authors as $author)
                    <div class="row-card">
                        ...
                        <div class="right-block">
                            ...
                            <form method="POST" action="{{ route('admin.authors.destroy', $author->id) }}" onsubmit="return confirm('Supprimer cet auteur ?')">
                                @csrf
                                @method('DELETE')
